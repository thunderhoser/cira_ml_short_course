...
from cira_ml_short_course.plotting import image_plotting
...
def _plot_novelty_maps(novelty_matrix, predictor_names, max_temp_diff_kelvins,
    ...
    for k in range(len(non_wind_predictor_names)):
        ...
        image_plotting.plot_scalar_field_2d(
        ...
        this_colour_bar_object = image_plotting.plot_linear_colour_bar(
        ...
        this_colour_bar_object.set_label(
            non_wind_predictor_names[k],
            fontsize=image_plotting.DEFAULT_CBAR_FONT_SIZE
        )
...
def run_novelty_detection(
    ...
    baseline_feature_matrix = cnn.apply_model(
    ...
    trial_feature_matrix = cnn.apply_model(
        model_object=cnn_model_object,
...
def plot_results(novelty_dict_denorm, plot_index, predictor_names):
    ...
    reflectivity_index = predictor_names.index(image_utils.REFLECTIVITY_NAME)
    ...
    _, axes_object_matrix = image_plotting.plot_many_predictors_with_barbs(
